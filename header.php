...
<head>
    ...
    <style>
        ...
        * {
        ...
        main h1 { font-size: 2.5rem; font-weight: 700; color: var(--text-color); margin-bottom: 1rem; }
        main h2 { font-size: 1.8rem; font-weight: 600; color: var(--text-color); margin-bottom: 2rem; }
        ...
        .voucher-card:hover { transform: translateY(-5px); box-shadow: 0 15px 35px rgba(0,0,0,0.12); }
        .voucher-card img {
            width: 100%;
            height: 150px;
            background: #eee;
        ...
        .voucher-card p { font-size: 1.1rem; font-weight: 600; margin-bottom: 8px; }
        .voucher-card small { font-size: 0.9rem; color: var(--text-secondary-color); margin-bottom: 20px; display: block; }
        .voucher-card button {
        ...
        @media (max-width: 500px) { .voucher-grid { grid-template-columns: 1fr; } }
    </style>
</head>
<body>
